...
export const VENDOR_BREAKDOWN = [
  { month: 'Jan 2025', eg: 35, us: 20, eu: 30 },
  { month: 'Feb 2025', eg: 30, us: 30, eu: 32 },
  { month: 'Mar 2025', eg: 24, us: 20, eu: 30 },
  { month: 'Apr 2025', eg: 28, us: 30, eu: 24 },
  { month: 'May 2025', eg: 10, us: 28, eu: 32 },
  { month: 'Jun 2025', eg: 13, us: 30, eu: 33 },
  { month: 'Jul 2025', eg: 10, us: 20, eu: 30 },
  { month: 'Aug 2025', eg: 20, us: 30, eu: 35 },
  { month: 'Sept 2025', eg: 10, us: 20, eu: 30 },
  { month: 'Oct 2025', eg: 28, us: 30, eu: 20 },
  { month: 'Nov 2025', eg: 24, us: 30, eu: 30 },
  { month: 'Dec 2025', eg: 35, us: 40, eu: 20 },
];
...
export const APP_SIDEBAR = {
  ...
  curProfile: {
    src: myPhoto,
    name: 'Bassam Mahmoud',
    email: 'bassam.mahmoud@example.com',
  },
  allProfiles: [
    {
      src: myPhoto,
